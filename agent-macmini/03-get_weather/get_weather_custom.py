...
input_list = [
    {"role": "user", "content": "我的星座运势是什么？我是巨蟹座。"}
]
...
print("***************************************")
print("得到模型输出：response :")
print(response.model_dump_json(indent=2))
print("***************************************")
print("得到模型输出：response.choices[0].message :")
...
print("***************************************")
print("最终输入:" + json.dumps(input_list, ensure_ascii=False, indent=2))
